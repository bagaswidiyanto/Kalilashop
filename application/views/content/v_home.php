                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-card">
                            <img class="avatar img-fluid"
                                src="https://admin103.kalilashop.com/upload/populer/<?= $p->image; ?>"
                                alt="testimonial">
                                ...
                                <div class="testimonial-card">
                                    <div class="row">
                                        <div class="col-lg-5 col-md-5 col-sm-5 col-5">
                                            <div class="img-set">
                                                <img class="avatar img-fluid"
                                                    src="https://admin103.kalilashop.com/upload/set_hijab/<?= $sh->image; ?>"
                                                    alt="testimonial">
                                            </div>
                                        </div>
                                        <div class="col-lg-7 col-md-7 col-sm-7 col-7">
                                            <div class="text-side">
                                                ...
                                                <div class="check pt-1">
                                                    <p><img src="<?= base_url(); ?>assets/imagenew/check.png"
                                                            class="img-fluid" alt=""><?= $sh->deks1; ?></p>
                                                    <p><img src="<?= base_url(); ?>assets/imagenew/check.png"
                                                            class="img-fluid" alt=""><?= $sh->desk2; ?></p>
                                                    <p><img src="<?= base_url(); ?>assets/imagenew/check.png"
                                                            class="img-fluid" alt=""><?= $sh->desk3; ?></p>
                                                </div>
                                            </div>
                                            <div class="btn-order pt-2">
                                                <a href="https://wa.wizard.id/a8d0c5" target="_blank">Pesan Sekarang</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="row p-2">
            <div class="col-lg-12">
                    ...
                    <div class="swiper-container katalog-slider">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card">
                                    <img class="avatar img-fluid"
                                        src="https://admin103.kalilashop.com/upload/katalog/<?= $k->image; ?>"
                                        alt="testimonial">
                                    <div class="p-2 text-black">
                                        <div class="btn-more">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <a href="https://wa.wizard.id/a8d0c5" target="_blank">More</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="cek-katalog text-center pt-3">
                    ...
                    <div class=" pt-2">
                        <a href="https://wa.wizard.id/a8d0c5" target="_blank" class="btn-wa"><i
                                class="fa fa-whatsapp"></i><?= $wa; ?></a>
                    </div>
                </div>
                    ...
                    <div class="swiper-container galeri-produk1-slider">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card">
                                    <img class="avatar img-fluid"
                                        src="https://admin103.kalilashop.com/upload/gallery1/<?= $g1->image; ?>"
                                        alt="testimonial">
                                </div>
                            </div>
                            <?php } ?>
                    ...
                    <div class="swiper-container galeri-produk2-slider">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card">
                                    <img class="avatar img-fluid"
                                        src="https://admin103.kalilashop.com/upload/gallery2/<?= $g2->image; ?>"
                                        alt="testimonial">
                                </div>
                            </div>
                            <?php } ?>
                    ...
                    <div class="swiper-container galeri-produk3-slider">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card">
                                    <img class="avatar img-fluid"
                                        src="https://admin103.kalilashop.com/upload/gallery3/<?= $g3->image; ?>"
                                        alt="testimonial">
                                </div>
                            </div>
                            <?php } ?>
