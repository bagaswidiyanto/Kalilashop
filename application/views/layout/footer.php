            ...
            <div class="col-lg-7 pt-1">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-12 pt-3">
                        <div class="call-me">
                            ...
                            <div class="pt-2">
                                <a class="btn-wa" href="https://wa.wizard.id/a8d0c5" target="_blank"><i
                ...
                <div class="sosmed mt-4">
                    ...
                    <div class="sosmed-link">
                        <a href="<?= $s->link; ?>" target="_blank"><img class="img-fluid"
                                src="https://admin103.kalilashop.com/upload/<?= $s->icon; ?>" alt="">
                            <?= $s->name; ?></a>
                    </div>
                    <?php } ?>
                </div>
...
<div class="whatsapp-chat-section">
    ...
    <div id="whatsapp-chat-popup" class="animate__animated animate__bounceOutDown"
        ...
        <div id="list-chat-section" class="list-chat-section animate__animated animate__fadeIn" style="display: block;">
            <div class="header-section" style="background:  linear-gradient(180deg, #CF3AFF 0%, #2FACFF 100%);">
                ...
                <div class="header-avatar-section">
                    ...
                    <div class="avatar">
                        <img class="avatar"
                            ...
                            src="https://admin103.kalilashop.com/upload/wa_image/<?= $sec1->image; ?>">
                    </div>
                    <? } ?>
                </div>
            ...
            <div class="chat-section">
                ...
                <div class="cs-section" onclick="chatCustomer(<?= $sec2->id; ?>);">
                    <div class="avatar">
                        <img class="avatar" src="https://admin103.kalilashop.com/upload/wa_image/<?= $sec2->image; ?>">
                    </div>
                    <div class="profile">
            ...
            <div class="header-section" style="background: linear-gradient(180deg, #CF3AFF 0%, #2FACFF 100%);">
                ...
                <div class="header-avatar-section">
                    <div class="avatar">
                        <img class="avatar"
                            style="position: relative; display: inline-block; vertical-align: middle; height: 60px; width: 60px; border-radius: 60px;"
                            src="https://admin103.kalilashop.com/upload/wa_image/<?= $sec3->image; ?>">
                    </div>
                </div>
            ...
            <div class="inside-chat-section">
                <div class="chat">
                    <div class="inside-chat">
                        <span>Halo saya <?= ucwords(strtolower($sec3->nama)); ?>, dari Kalila Shop.</span>
                    </div>
                    <div class="time">
...
<script src="<?= base_url(); ?>assets/js/script.js"></script> <!-- Custom scripts -->
